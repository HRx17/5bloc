...
export const metadata: Metadata = {
  title: '5Bloc vs Procore — AEC project coordination for architect-led teams',
  description:
    'Procore is built for GC-led enterprise programmes. 5Bloc is built for architect-led practices: price transparency, India compliance, and no per-seat cost for invited users.',
  openGraph: {
    title: '5Bloc vs Procore',
    url: `${SITE_URL}/vs/5bloc-vs-procore`,
    images: [{ url: '/images/og.png', width: 1200, height: 630, alt: '5Bloc vs Procore' }],
  },
}
...
export default function FiveBlocVsProcore() {
  return (
    <ComparePage
      title="5Bloc vs Procore"
