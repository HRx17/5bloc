...
export const metadata: Metadata = {
  title: 'About — 5Bloc',
  description:
    'Haet Ranpariya and Parth Mehta founded 5Bloc so architect-led teams can run drawings, RFIs, and client approvals in one workspace — without another app to install.',
  openGraph: {
    title: 'About — 5Bloc',
