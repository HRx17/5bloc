  ...
  const [integrations, setIntegrations] = useState<IntegrationItem[]>([
    {
      ...
      icon: 'cloud_queue',
      color: '#4285F4',
      description: 'Sync design sheets and project files with Google Drive.',
      status: 'disconnected',
      lastSync: 'Never',
      syncedItemsCount: 0,
      category: 'workspace',
    },
    {
      ...
      icon: 'mail',
      color: '#EA4335',
      description: 'Ingest quotes and approvals from email into RFIs.',
      status: 'disconnected',
      lastSync: 'Never',
      syncedItemsCount: 0,
    ...
    },
    {
      ...
      icon: 'chat',
      color: '#25D366',
      description: 'Link site supervisor chats and log snags from photos.',
      status: 'disconnected',
      lastSync: 'Never',
      syncedItemsCount: 0,
      category: 'communication',
    },
    {
      ...
      icon: 'architecture',
      color: '#D82424',
      description: 'Inspect drawings and models. Clash detection coming soon.',
      status: 'disconnected',
      lastSync: 'Never',
      syncedItemsCount: 0,
