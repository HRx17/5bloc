...
export const Route = createFileRoute('/privacy')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'How 5Bloc collects, uses, and safeguards your information across the project coordination platform.' },
      { property: 'og:title', content: 'Privacy Policy — 5Bloc' },
      { property: 'og:description', content: 'How 5Bloc collects, uses, and safeguards your information across the project coordination platform.' },
